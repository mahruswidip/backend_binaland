...
@section('content')
@include('layouts.navbars.auth.topnav', ['title' => 'Fasilitas'])
        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0 d-flex align-items-center">
                    ...
                    <a href="{{ route('fasilitas.add') }}" class="btn bg-gradient-primary btn-sm ms-auto">
                        <span class="fa fa-plus">&nbsp;</span> Tambah Fasilitas
                    </a>
                </div>
                <div class="card-body px-0 pt-0 pb-2">
                    <div class="table-responsive px-5 py-2">
                        <table id="dataTable-fasilitas" class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="lebar-tabel1 text-center">
                                            <div style="max-height: 100px; overflow-y: auto;" class="d-flex flex-wrap justify-content-center">
                                                @foreach ($item->gambarFasilitas as $gambar)
                                                    <img src="{{ asset('storage/' . $gambar->gambar) }}" width="100" class="m-1 rounded">
                                                @endforeach
                                            </div>
                                        </td>
                                        <td class="lebar-tabel text-center">
                                            <a href="{{ route('fasilitas.edit', $item->id_fasilitas) }}" class="btn bg-gradient-info btn-sm">Edit</a>
                                            ...
                                            <a href="{{ route('fasilitas.detail', $item->id_fasilitas) }}" class="btn bg-gradient-success btn-sm">Tinjau</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
